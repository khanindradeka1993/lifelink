...
export default async function handler(req, res) {
  ...
  try {
    ...
    // The frontend deliberately uses skipSetup=true so an existing PIN is
    // never re-requested on every transaction. If Circle says a PIN/setup
    // challenge is genuinely required, wallet creation will return that
    // challenge and the SDK can complete it.
